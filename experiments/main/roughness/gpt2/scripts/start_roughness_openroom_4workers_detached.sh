...
API_KEY="${AZURE_ROUGHNESS_OPENAI_API_KEY:-${AZURE_GPT_IMAGE_2_API_KEY:-${AZURE_OPENAI_API_KEY:-${OPENAI_API_KEY:-${GPT_IMAGE_API_KEY:-}}}}}"
...
setsid env \
  ...
  BASE_OUTPUT_DIR="${BASE_OUTPUT_DIR:-/path/to/benchmark_outputs/roughness_gpt2}" \
