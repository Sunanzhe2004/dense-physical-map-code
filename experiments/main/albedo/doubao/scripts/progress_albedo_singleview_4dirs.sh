...
BASE_OUTPUT_DIR="${BASE_OUTPUT_DIR:-/path/to/benchmark_outputs/albedo_doubao}"
FILENAME_SUFFIX="${FILENAME_SUFFIX:-*_im.png}"
OUTPUT_SUFFIX="${OUTPUT_SUFFIX:-*_im_albedo.png}"
...
OUTPUT_DIRS=(
  "${BASE_OUTPUT_DIR}/interiorverse_mainaxis/albedo"
  "${BASE_OUTPUT_DIR}/interiorverse_stresstest/albedo"
  "${BASE_OUTPUT_DIR}/openroomff_mainaxis/albedo"
  "${BASE_OUTPUT_DIR}/openroomff_stresstest/albedo"
)
