...
DEFAULT_EXAMPLE_RGB = "/path/to/benchmark_examples/normal/example3_rgb.png"
DEFAULT_EXAMPLE_NORMAL = "/path/to/benchmark_examples/normal/example3_normal.png"
DEFAULT_GT_ROOT = "/path/to/benchmark_data/GT"
DEFAULT_OUTPUT_DIR = "/path/to/benchmark_outputs/normal_gpt_example3"
