...
BASE_OUTPUT_DIR="${BASE_OUTPUT_DIR:-/path/to/benchmark_outputs/normal_gpt}"
FILENAME_SUFFIX="${FILENAME_SUFFIX:-_im.png}"
LOG_DIR="${LOG_DIR:-${BASE_OUTPUT_DIR}/logs}"
EXAMPLE_RGB="${EXAMPLE_RGB:-${SCRIPT_ROOT}/../examples/image.png}"
EXAMPLE_NORMAL="${EXAMPLE_NORMAL:-${SCRIPT_ROOT}/../examples/normal.png}"
